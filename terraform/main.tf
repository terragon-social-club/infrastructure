...
module "CouchDB" {
  ...
  salt_master_public_ip_address = module.Salt_Master.public_ip_address
  autogenerated_ssh_private_key = tls_private_key.autogenerated.private_key_pem
  couch_user = random_password.couch_user.password.result
  couch_pass = random_password.couch_pass.password.result
}
...
module "NodeJSAPI" {
  ...
  autogenerated_ssh_private_key = tls_private_key.autogenerated.private_key_pem
  couch_user = random_password.couch_user.password.result
  couch_password = random_password.couch_password.password.result
}
