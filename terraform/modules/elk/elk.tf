...
resource "digitalocean_firewall" "haproxy_and_heartbeat_to_kibana" {
  ...
  inbound_rule {
    protocol = "tcp"
    port_range = "5601"
    source_addresses = concat(module.HAProxy.salt_minion_private_ip_addresses, module.Heartbeat.salt_minion_private_ip_addresses)
  }
