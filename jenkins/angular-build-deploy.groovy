        ...
        if(exitCodeInstall != '0') {
            ...
            if(exitCodeBuild != '0') {
                ...
                withCredentials([
                    ...
                    def exitCodeSpacesUpload = sh "AWS_DEFAULT_REGION=NYC3 AWS_ACCESS_KEY_ID=${DO_SP_ID} AWS_SECRET_ACCESS_KEY=${DO_SP_SC} aws s3 sync dist s3://www-terragon-us/", returnStatus: true
