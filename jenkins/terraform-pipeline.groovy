        ...
        withCredentials([
            ...
            if (apply) {
                ...
                if (applyExitCode == "0") {
                    ...
                    sh 'cd terraform; git add . && git commit --message "A pleasure, sir. -- Jenkins"; git push origin master'
                    
                } else {
                    sh 'cd terraform; rm status.apply; rm /tmp/plan.out'
                    sh 'cd terraform; git add . && git commit --message "Something went wrong. -- Jenkins"; git push origin master'
